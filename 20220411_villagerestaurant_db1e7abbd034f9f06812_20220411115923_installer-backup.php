...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220411_villagerestaurant_db1e7abbd034f9f06812_20220411115923_archive.zip';
	const ARCHIVE_SIZE		 = '1161957967';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'db1e7ab-11115923';
    const SECONDARY_PACKAGE_HASH = 'fff0e8a-11115923';
	const VERSION			 = '1.4.4';
